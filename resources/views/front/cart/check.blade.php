	...
	<div class="container-cpns">
		<div class="row">
			<div class="col-lg-12 d-flex justify-content-center align-items-center">
				<a href="{{ url('/cart') }}" class="header-nav-link"><span>1.</span> Pilih tryout</a>
				...
				<a href="#" class="header-nav-link header-nav-active"><span>2.</span> Periksa</a>
				<div class="header-arrow-right">
					<svg width="9" height="13" viewBox="0 0 9 13" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M0 11.4617L4.96167 6.5L0 1.5275L1.5275 0L8.0275 6.5L1.5275 13L0 11.4617Z" fill="black" fill-opacity="0.25"/>
					</svg>
						...
						<form class="main-box">
							...
							<div class="border-b-1px py-3">
								<div class="d-flex align-items-center justify-content-between mb-3">
									...
									<span class="subtotal">Rp {{ $total }}</span>
								</div>
							...
							<div class="pt-3">
								...
								<a href="{{ url('cart/payment') }}" id="btn-submit-keranjang" class="btn-beli btn-beli-active py-2">Beli</a>
							</div>
						</form>
					</aside>
				</div>
